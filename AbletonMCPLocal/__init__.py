...
class AbletonMCPLocal(SessionCommands, ArrangementCommands, BrowserCommands, DeviceCommands, SceneCommands, AutomationCommands, ControlSurface):
    ...
    def _build_dispatch_table(self):
        ...
        self.READ_DISPATCH = {
            ...
            "get_return_track_info":     lambda p: self._get_return_track_info(p.get("return_track_index", 0)),
            ...
            "get_rack_devices":          lambda p: self._get_rack_devices(p.get("track_index", 0), p.get("device_index", 0)),
